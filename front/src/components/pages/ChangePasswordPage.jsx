...
function ChangePasswordPage() {
    ...
    const onPasswordSubmitHandler = (e) => {
        e.preventDefault();
        axios.put(`/member/update-pwd/${loginId}`, null, {params: {studentNo: loginId, newPaasword: newPaasword}})
            .then((res) => {
                console.log(res);
                // navigate('/myPage');
            })
            ...
            <form id="changePasswordSection" onSubmit={onPasswordSubmitHandler}>
                ...
                <div id="inputFormSpace">
                    <div id="SubtitleForm">
                        ...
                        <input onChange={onPasswordHandler} type="text" id="inputForm" autoFocus></input>
                    </div>
                </div>
                <div id="buttonSpace">
